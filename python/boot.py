from usb_hid import Device, enable
...
absolute_mouse = Device(
    ...
    usage=2,
    in_report_lengths=(6,),
    # Number of bytes in the send report = 1 byte for buttons, 2 bytes for x, 2 bytes for y, 1 byte for wheel
    out_report_lengths=(0,),
    report_ids=(11,),
)

enable((absolute_mouse,), boot_device=0)
